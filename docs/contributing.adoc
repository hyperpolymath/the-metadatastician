...
= Contributing — the-metadatastician
:revdate: 2026-MM-DD

== Audience

Developers working *on* `the-metadatastician`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/the-metadatastician.git
cd the-metadatastician
...
* Bugs in `the-metadatastician`: file at `hyperpolymath/the-metadatastician/issues`.
